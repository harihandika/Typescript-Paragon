...
const users: UserDataType[] = [
  {
    ...
    defaultRole: 'admin',
    menuPermissions: {
      admin: ['dashboardNavItem', 'chatNavItem', 'userNavItem', 'accountNavItem', 'school-details-navitem'],
      teacher: ['dashboardNavItem', 'chatNavItem', 'userNavItem', 'school-details-navitem'],
      student: ['dashboardNavItem', 'chatNavItem']
    },
    dashletsPermission: {
      admin: ['analytics', 'sales', 'revenue', 'earning-report', 'support-tracker'],
      teacher: ['analytics', 'sales', 'support-tracker'],
  ...
  if (request.data.length > 0) {
    ...
    if (!error.username && !error.email) {
      ...
      const userData = {
        ...
        menuPermissions: {
          admin: ['all'],
          teacher: ['school-setup', 'manage-grade'],
          student: ['manage-grade']
        },
        dashletsPermission: {
          admin: ['all'],
