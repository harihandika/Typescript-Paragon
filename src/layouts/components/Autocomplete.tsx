// ** React Imports
import { useEffect, useCallback, useRef, useState, ChangeEvent, useContext } from 'react'
...
// ** Search Modal With Category Icon and Path
    ...
    suggestions: [
      {
        ...
        suggestion: 'School Details',
        link: '/module/school-details',
        subject: 'school-details-navitem'
      },
      {
        icon: 'tabler:category',
        suggestion: 'Manage Program',
        link: '/module/manage-program',
        subject: ''
      },
      {
        icon: 'tabler:category',
        suggestion: 'Manage Grades',
        link: '/module/manage-grades',
        subject: ''
      },
      {
        icon: 'tabler:category',
        suggestion: 'Manage Sections',
        link: '/module/manage-sections',
        subject: ''
      },
      {
        icon: 'tabler:category',
        suggestion: 'Manage Subjects',
        link: '/module/manage-subjects',
        subject: ''
      },
      {
        icon: 'tabler:category',
        suggestion: 'Manage Departments',
        link: '/module/manage-departments',
        subject: ''
      },
      {
        icon: 'tabler:category',
        suggestion: 'Manage Wings',
        link: '/module/manage-wings',
        subject: ''
      },
      {
        icon: 'tabler:category',
        suggestion: 'Manage Coordinations',
        link: '/module/manage-coordinations',
        subject: ''
      }
    ]
  }
        ...
        <Grid item xs={12} sm={6} key={index}>
          ...
          <List sx={{ py: 2.5 }}>
            {item.suggestions.map((suggestionItem, index2) =>
              ability.can('read', suggestionItem.subject) ? (
